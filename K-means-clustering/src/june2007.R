...
head(df)
#     station     date    hours  temp     dewpoint  stationpressure  windspeed
...
table(df$temp==999.9)                 #48 rows have 999.9 value
...
#1  690190     78.7   66.1   475.   6.94
#2  720110     80.1   72.6   469.   3.94
#3  720151     75.2   51.2   434.   6.14
...
clusters_euclidean_2007$withinss #426.3836 15403.7272
sum(clusters_euclidean_2007$withinss) #15830.11
...
clusters_euclidean_2007$withinss #45.26965 15403.72721  1535.15023
sum(clusters_euclidean_2007$withinss) #16984.15
...
clusters_euclidean_2007
clusters_euclidean_2007$withinss # 426.38358 3144.66973 4701.04444   26.10237
sum(clusters_euclidean_2007$withinss)#8298.2
plotcluster(avg_common, clusters_euclidean_2007$cluster,xlab="Cluster Analysis")
autoplot(clusters_euclidean_2007,avg_common, frame=TRUE)
...
clusters_euclidean_2007
clusters_euclidean_2007$withinss #3144.6697  267.9259  136.3043 4701.0444  426.3836
sum(clusters_euclidean_2007$withinss)#8676.328
plotcluster(avg_common, clusters_euclidean_2007$cluster,xlab="Cluster Analysis")
autoplot(clusters_euclidean_2007,avg_common, frame=TRUE)
...
clusters_euclidean_2007$withinss#3138.2058  263.5682  135.3028 4700.6926  424.2264
sum(clusters_euclidean_2007$withinss)#8676.328
...
clusters_pearson_2007$withinss #1.313362e-11 1.089623e-04
sum(clusters_pearson_2007$withinss) #0.0001089624
...
clusters_pearson_2007$withinss #3.223867e-02 1.313362e-11 1.935901e-04
sum(clusters_pearson_2007$withinss)#0.03243226
plotcluster(avg_common, clusters_pearson_2007$cluster,xlab="Cluster Analysis")
...
clusters_pearson_2007$withinss #1.313362e-11 4.795733e-09 8.129791e-07 1.935901e-04
sum(clusters_pearson_2007$withinss)#0.0001944079
plotcluster(avg_common, clusters_pearson_2007$cluster,xlab="Cluster Analysis")
autoplot(clusters_pearson_2007,avg_common, frame=TRUE)
...
clusters_pearson_2007
clusters_pearson_2007$withinss #4.795733e-09 8.129791e-07 1.313362e-11 1.382627e-04 6.235531e-11
sum(clusters_pearson_2007$withinss)#0.0001390806
plotcluster(avg_common, clusters_pearson_2007$cluster,xlab="Cluster Analysis")
autoplot(clusters_pearson_2007,avg_common, frame=TRUE)
...
clusters_pearson_2007_7$withinss #1.302246e-05 0.000000e+00 0.000000e+00 4.795733e-09 8.129791e-07 6.519520e-11 1.393188e-11
sum(clusters_pearson_2007_7$withinss)# 1.384031e-05
...
clusters_euclidean_2007_S20_2$withinss #15403.7272   426.3836
sum(clusters_euclidean_2007_S20_2$withinss)#15830.11
...
clusters_pearson_2007_S20$withinss # 1.089623e-04 1.313362e-11
sum(clusters_pearson_2007_S20$withinss)#0.0001089624
plotcluster(avg_common, clusters_pearson_2007$cluster,xlab="Cluster Analysis")
autoplot(clusters_pearson_2007,avg_common, frame=TRUE)
