...
# Optimized decision tree with cp = 0.005
dtree_mincp <- rpart(
  y ~ ., 
  data = train_rows, 
  method = "class",
...
print(dtree_mincp)
#The attributes duration,euribor3m,nr.employed,month,job,campaign,pdays,poutcome are being used in the construction of optimal tree.
...
#[1] 0.9235000 0.6666667 0.5000000 0.5714286
...
# dtree_mincp.variable.importance: 80:20
# duration                            351.264842
# nr.employed                         195.200222
# euribor3m                           192.872899
# cons.conf.idx                       135.343103
# emp.var.rate                        125.935773
# cons.price.idx                      101.138383
# month                                84.808792
# pdays                                37.813844
# poutcome                             37.049333
# previous                             15.509021
...
#withhold the parameter:euribor3m which has the high importance and check if the accuracy changes as we had identified this parameter as non relevant using correlation matrix
...
#[1] 0.9245000 0.7226891 0.4215686 0.5325077
...
#[1] 0.9155000 0.5977654 0.5245098 0.5587467
...
#[1] 0.9185000 0.6198830 0.5196078 0.5653333
...
#The attributes age,education,previous,emp.var.rate,cons.conf.idx are not used in the construction of the tree
train_drop_unused<-train_rows[-c(1,3,9,11,13)]
train_drop_unused
